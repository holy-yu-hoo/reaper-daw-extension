...
std::vector<COMMAND_T> commands = {
	...
	{ID_PREFIX "FILL_EACH_2_STEPS_IN_SELECTED_ITEMS", NAME_PREFIX "fill each 2 steps", nullptr, fill_each_n_steps_in_selected_items, SECTION_MAIN,nullptr,0,2},
	{ID_PREFIX "FILL_EACH_4_STEPS_IN_SELECTED_ITEMS", NAME_PREFIX "fill each 4 steps", nullptr, fill_each_n_steps_in_selected_items, SECTION_MAIN,nullptr,0,4},
	{ID_PREFIX "FILL_EACH_8_STEPS_IN_SELECTED_ITEMS", NAME_PREFIX "fill each 8 steps", nullptr, fill_each_n_steps_in_selected_items, SECTION_MAIN,nullptr,0,8},
	{ID_PREFIX "FILL_EACH_16_STEPS_IN_SELECTED_ITEMS", NAME_PREFIX "fill each 16 steps", nullptr, fill_each_n_steps_in_selected_items, SECTION_MAIN,nullptr,0,16},
	...
	{ID_PREFIX "FILL_EACH_2_STEPS_WITH_DEL_IN_SELECTED_ITEMS", NAME_PREFIX "fill each 2 steps (delete before)", nullptr, fill_each_n_steps_with_del_in_selected_items, SECTION_MAIN,nullptr,0,2},
	{ID_PREFIX "FILL_EACH_4_STEPS_WITH_DEL_IN_SELECTED_ITEMS", NAME_PREFIX "fill each 4 steps (delete before)", nullptr, fill_each_n_steps_with_del_in_selected_items, SECTION_MAIN,nullptr,0,4},
	{ID_PREFIX "FILL_EACH_8_STEPS_WITH_DEL_IN_SELECTED_ITEMS", NAME_PREFIX "fill each 8 steps (delete before)", nullptr, fill_each_n_steps_with_del_in_selected_items, SECTION_MAIN,nullptr,0,8},
	{ID_PREFIX "FILL_EACH_16_STEPS_WITH_DEL_IN_SELECTED_ITEMS", NAME_PREFIX "fill each 16 steps (delete before)", nullptr, fill_each_n_steps_with_del_in_selected_items, SECTION_MAIN,nullptr,0,16},
};
